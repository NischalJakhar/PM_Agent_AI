...
knowledge_agent = KnowledgeAugmentedPromptAgent(  # TODO: 2 - Instantiate the KnowledgeAugmentedPromptAgent
...
evaluation_agent = EvaluationAgent(  # TODO: 3 - Instantiate the EvaluationAgent with a maximum of 10 interactions
    openai_api_key=openai_api_key,
    persona=persona,
